...
//		printf("\n");
	...
	//Initial assignment
	double cost0 = 0; //the previous-state cost
...
//		printf("%f\n", costMat[assignment[i].first][assignment[i].second]);
	...
	double initialAssignCost = cost0;
	
	double kT = cost0*0.5;			//Initial temperature for the SA algorithm
